...
class View(gtk.Window):
    def __init__(self, buffer=None):
        ...
        Outwin_FTP.views.push(self)

        buffer.ref()
  
        if not Outwin_FTP.colormap:
            Outwin_FTP.colormap = self.get_colormap()
    ...
    def delete_event_cb(self, window, event, data=None):
        Outwin_FTP.active_window_stack.push(self)
        self.check_close_view()
        Outwin_FTP.active_window_stack.pop()
        return True
    #
    # Menu callbacks
    #
    ...
    def movable_child_callback(self, child, event):
        ...
        info = child.get_data("Outwin_FTP-move-info")
        ...
        if not info:
            ...
            info['start_y'] = -1
            info['button'] = -1
            child.set_data("Outwin_FTP-move-info", info)
    ...
    def add_movable_child(self, text_view, window):
        ...
        color = Outwin_FTP.colormap.alloc_color(0xffff, 0, 0)
...
class Buffer(gtk.TextBuffer):
    ...
    def pretty_name(self):
        if self.filename:
            ...
            if self.untitled_serial == -1:
                self.untitled_serial = Outwin_FTP.untitled_serial
                Outwin_FTP.untitled_serial += 1
    ...
    def unref(self):
        ...
        if self.refcount == 0:
            ...
            Outwin_FTP.buffers.remove(self)
            del self
    ...
    def set_colors(self, enabled):
        ...
        for tag in self.color_tags:
            if enabled:
                color = apply(Outwin_FTP.colormap.alloc_color,
                              hue_to_color(hue))
    ...
    def fill_file_buffer(self, filename):
        try:
            ...
            view = Outwin_FTP.active_window_stack.get()
...
class Outwin_FTP():			#class testtext:
    untitled_serial = 1
    colormap = None
...
#    Outwin_FTP = Outwin_FTP(sys.argv[1:])
#    Outwin_FTP.main()
